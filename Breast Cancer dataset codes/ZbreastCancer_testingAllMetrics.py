...
def main():
    # Load training data
    training_filename = r"C:\Users\PRIYA DIVYA\Desktop\breastCancer dataset\Breast_encoded_forTraining.xlsx"  # Training Excel file path
    training_data = load_data(training_filename)

    # Load test data
    test_filename = r"C:\Users\PRIYA DIVYA\Desktop\breastCancer dataset\Breast_encoded_forTesting.xlsx"  # Testing Excel file path
