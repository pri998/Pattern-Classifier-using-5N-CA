...
def main():
    # Load training data
    training_filename = r"C:\Users\PRIYA DIVYA\Desktop\raisin dataset\raisin for Training.xlsx"  # Training Excel file path
    training_data = load_data(training_filename)

    # Load test data
    test_filename = r"C:\Users\PRIYA DIVYA\Desktop\raisin dataset\raisin for Testing.xlsx"  # Testing Excel file path
