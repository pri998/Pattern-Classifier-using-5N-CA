...
# File paths
input_path = r"C:\Users\PRIYA DIVYA\Downloads\raisin raw dataset_CSV.xlsx"
output_path = os.path.expanduser(r"C:\Users\PRIYA DIVYA\Downloads\raisin encoded_CSV.xlsx")

# Load the CSV file
df = pd.read_excel(input_path)

# Define lists of continuous attributes
continuous_attributes = ['Area', 'MajorAxis', 'MinorAxis', 'Eccentricity', 'ConvexArea','Extent','Perimeter']
